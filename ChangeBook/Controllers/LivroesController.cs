...
namespace ChangeBook.Controllers
{
    public class LivroesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Nome_livro,Editora,Autor,Ano,Edicao,Disponibilidade,GeneroId")] Livro livro)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Nome_livro,Editora,Autor,Ano,Edicao,Disponibilidade,GeneroId")] Livro livro)
        {
            if (ModelState.IsValid)
            {
